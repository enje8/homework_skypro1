...
2. В отчете Allure вы увидите:
   - **Название теста**: `Оформления заказа и проверка итоговой суммы`.
   - **Описание теста**: Тест проверяет добавление товаров в корзину, оформление заказа и корректность итоговой суммы.

   - **Шаги теста**:
     - Открыть страницу и выполнить вход
     - Добавить товары в корзину и перейти в корзину
